...
| [plan-graceful-shutdown.md](plan-graceful-shutdown.md) | Graceful shutdown / graceful reload implementation plan — phased delivery of X3 (`POST /reload`), Pattern D (graceful shutdown), and Pattern D′ (write-path contract); mermaid diagrams. |
