...
- Code base: every `file:line` below refers to the tree at the tip of
  ...
  been stable.
- Spikes: `docs/adr/0005-spikes/` in andypost/unit, branch `proto/h2h3-spikes` (an nghttp2 server and a quiche HTTP/3
...
The spike code is in andypost/unit, branch `proto/h2h3-spikes`, `docs/adr/0005-spikes/` with its README (build and
